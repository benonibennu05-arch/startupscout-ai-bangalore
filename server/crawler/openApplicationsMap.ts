...
export const REAL_OPEN_APPLICATIONS_MAP: Record<string, SeedOpenApp> = {
  ...
  'Darwinbox': {
    ...
    evidence: 'We are always looking for visionary builders, software engineers, and product enthusiasts eager to redefine the future of work. Write to our talent team at careers@darwinbox.com with your portfolio or CV.',
    contactEmail: 'careers@darwinbox.com',
    contactName: 'Darwinbox Talent Acquisition',
    contactRole: 'Talent Acquisition Team',
    relevanceScore: 96,
  },
  'Zenoti': {
    ...
    evidence: "Do not see an exact opening that matches your profile? We are constantly growing our cloud, mobile, and AI engineering teams. Send your resume to talent@zenoti.com to explore upcoming opportunities.",
    contactEmail: 'talent@zenoti.com',
    contactName: 'Zenoti Global Talent Team',
    contactRole: 'Global Talent Acquisition',
    relevanceScore: 94,
  },
  'Skyroot Aerospace': {
    ...
    evidence: 'Passionate about rocket science, propulsion systems, avionics software, or space missions? We are always on the lookout for bright minds. Share your resume and project links at careers@skyroot.in',
    contactEmail: 'careers@skyroot.in',
    contactName: 'Skyroot People & Culture',
    contactRole: 'Aerospace Talent Acquisition',
    relevanceScore: 97,
  },
  'Keka HR': {
    companyName: 'Keka HR',
    sourceUrl: 'https://www.keka.com/careers',
    evidence: "We believe great talent creates great software. If you love building high-performance web products, solving complex UX problems, or writing robust code, drop your resume at careers@keka.com",
    contactEmail: 'careers@keka.com',
    contactName: 'Keka Recruiting Team',
    contactRole: 'People Operations & Hiring',
    relevanceScore: 95,
  },
  'Dhruva Space': {
    companyName: 'Dhruva Space',
    sourceUrl: 'https://dhruvaspace.com/careers',
    evidence: 'Ready to build satellites and space tech infrastructure? Send your resume, engineering portfolio, or GitHub profile to careers@dhruvaspace.com for direct evaluation by our technical leads.',
    contactEmail: 'careers@dhruvaspace.com',
    contactName: 'Dhruva Space Talent Team',
    contactRole: 'SpaceTech Recruitment',
    relevanceScore: 93,
  },
  'Quixy': {
    companyName: 'Quixy',
    sourceUrl: 'https://quixy.com/careers',
    evidence: 'Passionate about the no-code revolution and cloud enterprise architecture? Connect with our talent team and submit your resume for future opportunities at careers@quixy.com',
    contactEmail: 'careers@quixy.com',
    contactName: 'Quixy Talent Operations',
    contactRole: 'Talent Acquisition',
    relevanceScore: 91,
  },
  'Marut Drones': {
    ...
    evidence: 'We are pioneering autonomous drone logistics and AI vision robotics. Join our flight. Send your CV and portfolio to careers@marutdrones.com',
    contactEmail: 'careers@marutdrones.com',
    contactName: 'Marut Drones Hiring Team',
    contactRole: 'Robotics & UAV Hiring',
    relevanceScore: 92,
  },
};
